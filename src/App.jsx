...
export default function App() {
  ...
  // ========== SEND MESSAGE — BUG FIXED FOR ANNOUNCEMENTS! ==========
  const sendMessage = useCallback(async () => {
    const text = input.trim()
    if (!text || isLoading) return

    // ========== ANNOUNCEMENTS (ADMIN ONLY) — FIXED NO BLANK SCREEN ==========
...
`}
  ...
  // ==================================================
  // ========== MAIN APP — FIXED LAYOUT + ENHANCED SIDEBAR ==========
  // ==================================================
  return (
    <div style={styles.app}>
      ...
      {/* HEADER — HAMBURGER + PROFILE — LOCKED LAYOUT! */}
      ...
      {/* ========== CHAT AREA — SCROLLABLE + BUG-FREE ANNOUNCEMENTS! ========== */}
      <div style={styles.chatArea}>
        ...
        {/* ========== ANNOUNCEMENTS TAB — ADMIN ONLY — BUG FIXED! ========== */}
...
const styles = {
  ...
  publicAvatar: { width: '28px', height: '28px', borderRadius: '50%', objectFit:
