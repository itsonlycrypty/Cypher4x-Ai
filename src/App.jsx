...
export default function App() {
  ...
  const [activeTab, setActiveTab] = useState("ai")   // AI tab is now first
...
const styles = {
  // --- Layout & Containers ---
  app: { 
    minHeight: '100dvh',          // FIX: use 100dvh to prevent layout shift
    height: '100dvh',             // FIX: use 100dvh
    backgroundColor: '#000', 
    color: '#e0e0e0', 
    display: 'flex', 
  ...
  chatArea: { 
    ...
    flexDirection: 'column',
    backgroundColor: '#050505',
    scrollbarGutter: 'stable'     // FIX: reserve space for scrollbar
  },
  banner: { 
  ...
  inputBar: { 
    display: 'flex', 
    padding: '8px 12px 20px 12px',   // raised: more bottom padding
    borderTop: '1px solid #333', 
    backgroundColor: '#0a0a0a', 
    gap: '8px', 
    alignItems: 'center',
    marginBottom: '4px'              // extra space from bottom
  },
  inputField: { 
    flex: 1, 
    padding: '10px', 
