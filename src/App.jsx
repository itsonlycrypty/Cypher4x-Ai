...
// ==============================================
// ⚡ CYPHER4X v17.0.5 — CRYPTY + MOLE EDITION
// ✅ Sidebar works in PORTRAIT mode (mobile-friendly toggle)
// ✅ Input bar ALWAYS visible — fixed position on mobile!
...
`}
  ...
  return (
    <div style={{ 
      ...
      width: '100%', 
      display: 'flex', 
      flexDirection: 'column', // ✅ CHANGED: column on mobile
      backgroundColor: '#000', 
      color: '#e0e0e0', 
      fontFamily: 'Courier New, monospace',
      overflow: 'hidden',
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden', position: 'relative' }}>
        ...
        >
          {/* Messages Area — scrollable, takes all space */}
          <div style={{ 
            flex: 1, 
            padding: '16px', 
            overflowY: 'auto',
          ...
          <div style={{ 
            ...
            <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
              <input
                ...
                placeholder="Ask anything — code, technical, NO restrictions →"
                style={{
                  flex: 1,
                  padding: '12px 16px',
                  backgroundColor: '#000',
        ...
        {showSidebar && (
          <>
            ...
            {/* Sidebar Panel */}
            <aside style={{ 
              position: isMobile ? 'absolute' : 'relative', // ✅ Overlay on mobile, normal on desktop
              top: 0,
              right: 0,
              bottom: 0,
              width: isMobile ? '85%' : '360px', // ✅ 85% width on mobile, fixed 360px on desktop
