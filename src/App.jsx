...
const DISPLAY_VERSION = "Version 20"
    ...
    return (
      <div style={styles.bootContainer}>
        <div style={styles.bigBanner}>
          ...
          <p style={styles.bannerVersion}>{DISPLAY_VERSION} • Created by {CREATED_BY} • Assisted by {ASSISTED_BY}</p>
    ...
    <div style={styles.app}>
            ...
            <div style={styles.sidebarSection}>
              ...
              <div style={styles.statsCard}>
                ...
                <div style={styles.statRow}>
                  ...
                  <span style={styles.statValue}>{DISPLAY_VERSION}</span>
                </div>
                <div style={styles.statRow}>
      ...
      <header style={styles.header}>
        ...
        <div style={styles.headerMeta}>
          <span style={styles.versionBadge}>{DISPLAY_VERSION}</span>
          <button
            onClick={() => setVoiceEnabled(!voiceEnabled)}
      ...
      <div ref={chatAreaRef} style={styles.chatArea}>
        <div style={styles.banner}>⚡ CYPHER4X — UNCENSORED • NO FILTERS • Created by {CREATED_BY} • Assisted by {ASSISTED_BY} • {DISPLAY_VERSION}</div>
        {aiMessages.length === 0 ? (
                ...
                <>
                  <div style={styles.msgSender}>
                    ...
                    <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                      ...
                      <button onClick={() => deleteMessage(msg.id)} style={styles.msgDeleteBtn}>🗑️ Delete</button>
                    </div>
                  </div>
...
const styles = {
  ...
  profileInfo: { flex: 1 },
  profileName: { fontSize: '16px', fontWeight: 'bold', color: '#fff', marginBottom: '2px' },
  profileHandle: { fontSize: '12px', color: '#888' },
  sidebarBtn: { 
    width: '100%', 
    padding: '12px', 
    backgroundColor: '#222', 
  ...
  heading: { color: '#ff003c', fontSize: '22px', marginBottom: '8px' },
  ...
  editedTag: { fontSize: '11px', color: '#888', fontStyle: 'italic', marginLeft: '4px' },
  msgVoiceBtn: { 
    backgroundColor: 'transparent', 
    border: 'none', 
    color: '#ff003c', 
  ...
  msgText: { fontSize: '15px', lineHeight: '1.6', whiteSpace: 'pre-wrap', wordBreak: 'break-word', marginBottom: '8px' },
  msgActions: { display: 'flex', gap: '8px', paddingTop: '8px', borderTop: '1px solid #222' },
  msgEditBtn: { 
    backgroundColor: 'transparent', 
    border: 'none', 
    color: '#ff003c', 
