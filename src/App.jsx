...
export default function App() {
  ...
  const [activeTab, setActiveTab] = useState("ai")   // <-- NOW DEFAULT TO AI
...
const styles = {
  ...
  inputBar: { 
    display: 'flex', 
    padding: '8px 12px 20px 12px',   // increased bottom padding
