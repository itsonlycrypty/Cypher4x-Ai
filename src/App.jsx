...
export default function App() {
    ...
    const animate = () => {
      ...
      stars.forEach(star => {
        ...
        if (x > 0 && x < canvas.width && y > 0 && y < canvas.height) {
          ...
          ctx.fillStyle = `rgba(255, 60, 100, ${brightness * 0.8})`
          ctx.fill()
          if (brightness > 0.8) {
  ...
  // ============================================================
  // BOOT SCREEN — 3D + particles + terminal
  // ============================================================
  if (isBooting) {
    return (
      <div style={styles.bootContainer}>
        <canvas ref={canvasRef} style={styles.starCanvas} />
        <div style={styles.glitchOverlay} />
        <div style={styles.loading3DContainer}>
          <div style={styles.loadingRing3D}>
