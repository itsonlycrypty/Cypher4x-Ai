...
export default function App() {
  ...
  const renderMessage = (msg, tab, contact = null) => {
    ...
    if (tab === "general") {
      ...
      // SPECIAL STYLE FOR ANNOUNCEMENTS - UPGRADED
      bubbleStyle = {
        ...bubbleStyle,
    ...
    // For announcements, add a "BREAKING" badge
  ...
  // ============================================================
  // BOOT SCREEN — RED/BLACK WITH INSANE ANIMATIONS
  // ============================================================
  if (isBooting) {
    // Separate "loading" animation (pulsing ring) and the terminal "typewriter"
    return (
      <div style={styles.bootContainer}>
        ...
        <div style={styles.bootContent}>
          ...
          {/* Terminal with typewriter – red/black theme */}
...
const styles = {
  ...
  // === CHAT AREA (unchanged except announcements) ===
  chatArea: {
    flex: 1,
    overflowY: 'auto',
    padding: '16px',
