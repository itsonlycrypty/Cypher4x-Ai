  ...
  return (
    <div style={styles.app}>
      ...
      <header style={styles.header}>
        ...
        <div style={styles.headerCenter}><span style={styles.logo}>☠️</span><h1 style={styles.title}>CYPHER4X</h1></div>
...
const styles = {
  ...
  skullIcon: { fontSize: '48px', marginBottom: '10px' },
  heading: { color: '#ff003c', fontSize: '24px', marginBottom: '10px' },
  subheading: { color: '#ff6688', fontSize: '
