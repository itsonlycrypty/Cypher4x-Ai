...
const MODEL_NAME = "openai/gpt-oss-120b"   // <-- reverted to this
          ...
          <div style={styles.sidebar}>
            ...
            <div style={styles.sidebarSection}>
              ...
              <div style={styles.statsCard}>
                ...
                <div style={styles.statRow}><span style={styles.statLabel}><Icon name="brain" size={14} color="#888" /> Model</span><span style={styles.statValue}>openai/gpt-oss-120b</span></div>   {/* <-- UPDATED */}
              </div>
            </div>
...
// ======================================
// STYLES (full) - identical to previous, omitted for brevity but identical to the last version
// ======================================
// ... (the styles object is exactly the same as in the previous code, I'll include it again for completeness but you can reuse the one from the last answer)
