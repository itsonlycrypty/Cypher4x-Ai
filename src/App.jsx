  ...
  const sendMessage = useCallback(async () => {
    ...
    if (activeTab === "ai") {
      setAiMessages(prev => [...prev, {
        role: "user", content: text, sender: profile?.name || "You",
      ...
      try {
        ...
        setAiMessages(prev => [...prev, {
          role: "assistant", content: reply, sender: "CYPHER4X", time: Date.now()
        }])
        setTimeout(() => speakText(reply), 300)
      } catch (err) {
        const errorMsg = `⚠️ ERROR: ${err.message}`
        setAiMessages(prev => [...prev, { role: "assistant", content: errorMsg, time: Date.now() }])
      }
      setIsLoading(false)
    }
      ...
      {sidebarOpen && (
        <>
          ...
          <div style={styles.sidebar}>
            ...
            <div style={styles.sidebarVersion}>CYPHER4X {VERSION} • Created by Crypty</div>
          </div>
        </>
      )}
...
const styles = {
  ...
  header: { padding: '12px 16px', borderBottom: '1px solid rgba(255,0,60,0.3)', background: 'linear-gradient(180deg, #1a0008, #0c0c0c)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexShrink: 0, minHeight: '56px' },
  hamburgerBtn: { backgroundColor: 'transparent', border: 'none', color: '#ff003c', fontSize: '24px', cursor: 'pointer', padding: '4px 8px' },
  ...
  voiceMiniBtn: { backgroundColor: 'transparent', border: '1px solid #444', borderRadius: '6px', fontSize: '18px', cursor: 'pointer', padding: '6px 8px', transition: 'all 0.2s' },
  voiceMiniOn: { borderColor: '#ff003c', backgroundColor: '#ff003c20' },
  headerProfileMini: { },
  miniAvatarSmall: { width: '36px', height: '36px', borderRadius: '50%', border: '2px solid #ff003c', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#1a1a1a', fontSize: '16px' },
  ...
  sidebar: { position: 'fixed', top: 0, left: 0, bottom: 0, width: '360px', maxWidth: '90vw', backgroundColor: '#0d0d0d', borderRight: '2px solid #ff003c', zIndex: 999, overflowY: 'auto', padding: '20px', display: 'flex', flexDirection: 'column', gap: '24px' },
  ...
  sectionTitle: { color: '#ff003c', fontSize: '13px', margin: '0 0 4px 0', borderBottom: '1px solid #222', paddingBottom: '6px', fontWeight: 'bold' },
  ...
  voiceToggleBtn: { padding: '6px 14px', borderRadius: '6px', border: 'none', fontSize: '13px', fontWeight: 'bold', cursor: 'pointer', transition: 'all 0.2s' },
  ...
  stopVoiceBtn: { padding: '6px 12px', backgroundColor: '#333', color: '#fff', border: 'none', borderRadius: '6px', fontSize: '12px', cursor: 'pointer', alignSelf: 'flex-start' },
  systemInfoPanel: { backgroundColor: '#0a0a0a', border: '1px solid #ff003c40', borderRadius: '8px', padding: '14px', display: 'flex', flexDirection: 'column', gap: '10px' },
  infoRow: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '12px' },
  infoLabel: { color: '#888' },
  infoValue: { color: '#ff6688', fontWeight: 'bold' },
  sidebarProfile: { display: 'flex', alignItems: 'center', gap: '12px' },
  sidebarAvatar: { width: '56px', height: '56px', borderRadius: '50%', border: '2px solid #ff003c', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#1a1a1a', flexShrink: 0 },
  ...
  sidebarAdminBadge: { fontSize: '10px', backgroundColor: '#ff003c', color: '#fff', padding: '2px 6px', borderRadius: '3px', alignSelf: 'flex-start', marginTop: '4px', fontWeight: 'bold' },
  sidebarBtn: { width: '100%', padding: '10px 12px', backgroundColor: '#1a1a1a', color: '#ddd', border: '1px solid #333', borderRadius: '6px', cursor: 'pointer', fontSize: '13px', textAlign: 'left', transition: 'all 0.2s' },
  systemPromptInput: { width: '100%', minHeight: '110px', padding: '12px', backgroundColor: '#000', border: '1px solid #ff003c', color: '#fff', borderRadius: '6px', fontSize: '13px', outline: 'none', resize: 'vertical', boxSizing: 'border-box', lineHeight: '1.5' },
  sidebarHint: { fontSize: '11px', color: '#666', marginTop: '4px', marginBottom: '4px' },
  resetPromptBtn: { width: '100%', padding: '8px', backgroundColor: 'transparent', color: '#ff6688', border: '1px solid #ff6688', borderRadius: '6px', cursor: 'pointer', fontSize: '12px', marginTop: '4px' },
  dangerBtn: { width: '100%', padding: '10px 12px', backgroundColor: 'rgba(255,50,50,0.15)', color: '#ff6666', border: '1px solid #ff3333', borderRadius: '6px', cursor: 'pointer', fontSize: '13px', textAlign: 'left' },
  sidebarVersion: { fontSize: '11px', color: '#444', textAlign: 'center', marginTop: 'auto', paddingTop: '16px' },
  tabsContainer: { display: 'flex', gap: '6px', padding: '10px 16px', borderBottom: '1px solid #333', flexShrink: 0, minHeight: '48px' },
  tab: { flex: 1, padding: '8px 6px', backgroundColor: '#111', border: '1px solid #333', color: '#888', borderRadius: '6px', fontSize: '11px', cursor: 'pointer', textAlign: 'center', transition: 'all 0.2s' },
  tabAiActive: { borderColor: '#ff003c', backgroundColor: '#2a0a12', color: '#ff6688', boxShadow: '0 0 8px #ff003c40' },
  tabPublicActive: { borderColor: '#00aaff', backgroundColor: '#0a1a2a', color: '#66ccff', boxShadow: '0 0 8px #00aaff40' },
  tabAnnActive: { borderColor: '#ffaa00', backgroundColor: '#2a220a', color: '#ffcc66', boxShadow: '0 0 8px #ffaa0040' },
  tabInactive: { },
  chatArea: { flex: 1, overflowY: 'auto', padding: '16px', display: 'flex', flexDirection: 'column', gap: '16px' },
  banner: { padding: '12px', backgroundColor: '#1a050a', border: '1px solid #ff003c60', borderRadius: '8px', color: '#ff6688', fontSize: '13px', textAlign: 'center', marginBottom: '8px' },
  publicBanner: { padding: '12px', backgroundColor: '#05101a', border: '1px solid #00aaff60', borderRadius: '8px', color: '#66ccff', fontSize: '13px', textAlign: 'center', marginBottom: '8px' },
  annBanner: { padding: '12px', backgroundColor: '#1a1505', border: '1px solid #ffaa0060', borderRadius: '8px', color: '#ffcc66', fontSize: '13px', textAlign: 'center', marginBottom: '8px' },
  emptyState: { textAlign: 'center', padding: '60px 20px', color: '#666' },
  skullIcon: { fontSize: '48px', marginBottom: '16px' },
  emptyIcon: { fontSize: '40px', marginBottom: '12px' },
  heading: { fontSize: '24px', color: '#ff003c', margin: '0 0 8px' },
  subheading: { fontSize: '14px', color: '#888', margin: 0 }
}
