  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden', position: 'relative' }}>
        ...
        {/* ✅ SIDEBAR — FULLY FIXED & COMPLETE! */}
        <div style={{
          position: 'absolute', top: 0, left: 0, bottom: 0, width: '320px',
          backgroundColor: '#0a0a0a', borderRight: '1px solid rgba(255,0,60,0.2)',
          transform: showSidebar ? 'translateX(0)' : 'translateX(-100%)',
          transition: 'transform 0.3s ease-in-out', zIndex: 100,
          display: 'flex', flexDirection: 'column', overflow: 'hidden'
        }}>
          {/* Sidebar Header */}
          <div style={{
            padding: '20px', borderBottom: '1px solid rgba(255,0,60,0.3)',
            background: 'linear-gradient(180deg, #1a0008, #0f0f0f)'
          }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <h2 style={{ color: '#ff003c', margin: 0, fontSize: '18px', fontWeight: 'bold' }}>⚙️ SETTINGS</h2>
              <button
          ...
          <div style={{ flex: 1, overflowY: 'auto', padding: '20px' }}>
            ...
            <div style={{ marginBottom: '28px' }}>
              <label style={{ 
                color: '#ff003c', fontSize: '14px', fontWeight: 'bold', 
              ...
              <textarea
                ...
                style={{
                  ...
                  backgroundColor: '#000', border: '1px solid #ff003c',
              ...
              <p style={{ fontSize: '11px', color: '#888', marginTop: '6px' }}>
                Edit AI behavior — changes apply to new responses
              </p>
            </div>
            ...
            <div style={{ marginBottom: '28px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <label style={{ color: '#ff003c', fontSize: '14px', fontWeight: 'bold' }}>🔊 AUTO VOICE</label>
                <button
                  onClick={() => setAutoVoice(!autoVoice)}
                  style={{
                    width: '50px', height: '26px', borderRadius: '13px',
                    backgroundColor: autoVoice ? '#ff003c' : '#333',
            ...
            {/* Danger Zone */}
            <div style={{ marginBottom: '20px' }}>
              <h3 style={{ color: '#ff6688', fontSize: '14px', fontWeight: 'bold', marginBottom: '12px' }}>⚠️ DANGER ZONE</h3>
              <button
                onClick={clearAllChat}
                style={{
                  width: '100%', padding: '12px', backgroundColor: 'rgba(255,0,60,0.15)',
                  border: '1px solid #ff003c', color: '#ff003c', borderRadius: '6px',
            ...
            {/* Version Info */}
            <div style={{ 
              padding: '15px', backgroundColor: '#111', borderRadius: '6px',
              border: '1px solid #222', marginTop: 'auto'
            }}>
              <p style={{ color: '#666', fontSize: '12px', margin: '0 0 5px' }}>
                  ...
                  userChat.map((msg) => (
                    ...
                    >
                      <div style={{ fontSize: '12px', color: '#888', marginBottom: '10px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        ...
                        <div style={{ display: 'flex', gap: '4px' }}>
                          {msg.username === profile.username && <button onClick={() => startEdit(msg, "userChat")} style={{ background: 'none', border: 'none', cursor: 'pointer
