...
// ==============================================
// ⚡ CYPHER4X v17.0.0 — CRYPTY + MOLE EDITION
// ✅ 100% UNCENSORED — answers ANY question honestly, NO refusal blocks
// ✅ PROFILE SYSTEM — COMPULSORY, cannot use AI without profile
// ✅ CROSS-DEVICE SYNC — chat history saved to cloud-ready storage
// ✅ ALL RED Boot Screen
...
export default function App() {
  ...
  // Auto-save messages to localStorage (cross-device ready — can be upgraded to cloud)
  useEffect(() => {
    if (profile) {
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <div style={{ textAlign: 'center', marginBottom: '28px' }}>
            ...
            <h1 style={{ color: '#ff003c', margin: '12px 0 4px', fontSize: '26px' }}>CYPHER4X</h1>
            <p style={{ color: '#888', fontSize: '13px' }}>{VERSION} • {CREATOR_LINE}</p>
            <p style={{ color: '#ff6688', fontSize: '14px', marginTop: '12px' }}>⚠️ Profile Required — Create to Continue</p>
          </div>

          <div style={{ marginBottom: '20px' }}>
            <label style={{ color: '#ff003c', fontSize: '13px', display: 'block', marginBottom: '6px' }}>
