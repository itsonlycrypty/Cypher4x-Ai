...
const styles = {
  ...
  tabInactive: { },
  chatArea: { flex: 1, overflowY: 'auto', padding: '16px', display: 'flex', flexDirection: 'column', gap: '16px', minHeight: 0 },
  chatContent: { display: 'flex', flexDirection: 'column', gap: '16px' },
