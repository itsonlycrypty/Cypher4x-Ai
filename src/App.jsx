              ...
              <div style={{ flex: 1, padding: '20px', overflowY: 'auto', overflowX: 'hidden' }}>
                ...
                <div style={{ marginBottom: '24px' }}>
                  ...
                  <button
                    ...
                    style={{ marginTop: '8px', padding: '6px 12px', backgroundColor: 'transparent', border: '1px solid #444', color: '#888', borderRadius: '4px', cursor: 'pointer', fontSize: '13px' }}
                  >
                    ↩️ Reset to Default
                  </button>
                </div>
                ...
                {/* 🎤 Auto Voice */}
                <div style={{ marginBottom: '24px' }}>
                  <label style={{ color: '#ff003c', fontSize: '14px', fontWeight:
