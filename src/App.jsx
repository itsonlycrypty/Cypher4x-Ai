  ...
  return (
    <div style={styles.app}>
      ...
      <div ref={chatAreaRef} style={styles.chatArea}>
        {activeTab === "general" && (
          <>
            <div style={styles.banner}>⚡ CYPHER4X v17.0.9 — UNCENSORED • NO FILTERS • Created by {CREATED_BY} • Assisted by {ASSISTED_BY} • {DISPLAY_VERSION}</div>
...
const styles = {
  ...
  adminBadge: { fontSize: '11px', color: '#ff003c', fontWeight: 'bold', marginTop: '2px' },
  sidebarBtn: { 
    width: '100%', 
    padding: '12px', 
    backgroundColor: '#222', 
