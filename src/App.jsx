        ...
        <div style={styles.bootContent}>
          ...
          <div style={styles.bootTerminal}>
            {BOOT_STEPS.map((step, i) => (
              <div key={i} style={styles.bootLine}>
                ...
                <span style={{
                  color: i < bootStep ? '#4f8' : (i === bootStep ? '#ff003c' : '#555'),
                  opacity: i < bootStep ? 0.8 : 1
                }}>
          ...
          <div style={styles.bootStatus}>
            {bootProgress < 100 ? (
              ...
              <span style={{ ...styles.bootStatusText, color: '#4f8' }}>✅ System ready</span>
            )}
          </div>
        </div>
      </div>
